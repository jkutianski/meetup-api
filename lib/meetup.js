...
class Meetup {
    ...
    get commands() {
        return Object.freeze(Object.keys(endpoints)); // delete this
    }
    get version() {
    ...
    [Symbol.iterator]() {
        ...
        return {
          next: () => ({ value: commands[++index], done: index === commands.length })
        };
    }

    // OAUTH functions
    getOAuthRequestToken(callback) {
        return this.oauth.getOAuthRequestToken({},
...
Meetup.prototype.commands.forEach(
    key => {
